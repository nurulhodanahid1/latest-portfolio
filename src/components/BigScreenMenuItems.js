        ...
        <>
            <ul style={{ color: `${props.linkColor}` }} className='hidden md:flex'>
              <li className='lg:ml-10 flex'>  {/*hover:border-b */}
                <a href="#about" className='transition font-semibold px-3 py-3 items-center text-xl leading-snug  hover:text-green-500 hover:scale-105 ease-out duration-300'>About</a>
              </li>
              <li className='lg:ml-10 flex'>
                <a href="#skills" className='transition font-semibold px-3 py-3 items-center text-xl leading-snug  hover:text-green-500 hover:scale-105 ease-out duration-300'>Skills</a>
              </li>
              <li className='lg:ml-10 flex'>
