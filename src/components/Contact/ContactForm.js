            ...
            <Fade right>
                <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 p-5 md:mt-0">
                    ...
                    <Fade bottom delay={1000}>
                        <button className="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-base font-semibold  transition duration-300">Send</button>
