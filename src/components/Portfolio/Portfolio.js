...
const Portfolio = () => {
    ...
    return (
        <div className="bg-slate-900" id="portfolio">
            <div className="container mx-auto px-6 py-20 text-gray-600">
                <Fade top duration={1000}>
                    <h2 className="text-center text-slate-200 md:text-5xl text-4xl font-medium">Something That <span className="text-blue-500">I've Build</span></h2>
                </Fade>
                ...
                <Rotate bottom right>
                    ...
                    {
                        projectsData.map(p =>
                            <div key={p.id} className="max-w-md rounded overflow-hidden shadow-lg bg-slate-800">
